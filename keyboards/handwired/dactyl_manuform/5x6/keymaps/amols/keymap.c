...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_L1] = LAYOUT_5x6(
     ...
     _______,_______,_______,S(KC_9),S(KC_0),_______,                        C(KC_LEFT), _______ , _______ , C(KC_RIGHT) ,_______,_______,
     _______,_______,_______,KC_LBRC,KC_RBRC ,_______,                        KC_LEFT, KC_DOWN , KC_UP , KC_RIGHT, _______, _______,
     _______,_______,_______,S(KC_LBRC),S(KC_RBRC), _______,                  KC_HOME, KC_PGDN , KC_PGUP , KC_END ,_______ ,_______,
  ...
  [_L5] = LAYOUT_5x6(
     _______,_______, _______ ,_______,_______ ,_______,                        _______,_______,_______,_______,_______,_______,
     _______,_______,_______,S(KC_9),S(KC_0),_______,                        A(KC_LEFT), _______ , _______ , A(KC_RIGHT) ,_______,_______,
     _______,_______,_______,KC_LBRC,KC_RBRC ,_______,                        KC_LEFT, KC_DOWN , KC_UP , KC_RIGHT, _______, _______,
     _______,_______,_______,S(KC_LBRC),S(KC_RBRC), _______,                  G(KC_LEFT), KC_PGDN , KC_PGUP , G(KC_RIGHT) ,_______ ,_______,
                                             _______,_______,            _______, _______,
                                             _______,_______,            _______,_______,
                                             _______,_______,            KC_DEL,_______,
                                             _______,_______,            _______,_______
